...
const AuthProvider = ({ children })=>{
    ...
    const refreshUser = async ()=>{
        ...
        if (authData) {
            const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$user$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].getProfile(authData.id);
            setUser({
                ...authData,
