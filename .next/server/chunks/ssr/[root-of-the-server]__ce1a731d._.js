...
"[project]/src/lib/user.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
        ...
        const setupUserSession = async (sessionUser)=>{
            if (sessionUser) {
                ...
                channel = supabase.channel('db-changes').on('postgres_changes', {
                    ...
                    schema: 'public',
                    table: 'messages'
                }, ()=>fetchAndSetConversations(sessionUser.id)).on('postgres_changes', {
                    event: '*',
                    schema: 'public',
                    table: 'conversations'
    ...
    const signup = async (name, email, pass)=>{
        try {
            const { user, profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$user$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].signUp(email, pass, {
                full_name: name
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce1a731d._.js.map