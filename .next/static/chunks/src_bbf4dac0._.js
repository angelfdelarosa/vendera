...
const LanguageProvider = ({ children })=>{
    ...
    const [locale, setLocaleState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "LanguageProvider.useState": ()=>{
            const savedLocale = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('locale');
            return savedLocale === 'en' || savedLocale === 'es' ? savedLocale : 'es';
        }
    }["LanguageProvider.useState"]);
    const setLocale = (newLocale)=>{
        setLocaleState(newLocale);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set('locale', newLocale, {
            expires: 365
        });
    };
    const value = {
...
_s(LanguageProvider, "dcVwGKY1N08N4L5MVcT6yKV+/B0=");
_c = LanguageProvider;
var _c;
...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://wqckkfepxumugmrrrdtu.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndxY2trZmVweHVtdWdtcnJyZHR1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM0OTM0MTksImV4cCI6MjA2OTA2OTQxOX0.vSZ4I-hJ4cUEvImvi8STTvA4UF19ZOVILoG5U17MsRM"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
"[project]/src/lib/user.service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = ({ children })=>{
    ...
    const fetchAndSetConversations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchAndSetConversations]": async (userId)=>{
            ...
            if (convos) {
                const transformedConversations = convos.map({
                    "AuthProvider.useCallback[fetchAndSetConversations].transformedConversations": (c)=>{
                ...
                "AuthProvider.useEffect.setupUserSession": async (sessionUser)=>{
                    ...
                    if (sessionUser) {
                        ...
                        channel = supabase.channel('db-changes').on('postgres_changes', {
                            ...
                            "AuthProvider.useEffect.setupUserSession": ()=>fetchAndSetConversations(sessionUser.id)
                        }["AuthProvider.useEffect.setupUserSession"]).on('postgres_changes', {
                            event: '*',
                            schema: 'public',
                            table: 'conversations'
                        }, {
                            "AuthProvider.useEffect.setupUserSession": ()=>fetchAndSetConversations(sessionUser.id)
                        }["AuthProvider.useEffect.setupUserSession"]).subscribe();
                    } else {
                        setUser(null);
                        setConversations([]);
                        if (channel) {
...
//# sourceMappingURL=src_bbf4dac0._.js.map