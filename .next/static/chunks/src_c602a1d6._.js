...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://noyztbqdgfniixzmpuac.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5veXp0YnFkZ2ZuaWl4em1wdWFjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMyOTcwNzEsImV4cCI6MjA2ODg3MzA3MX0.WcQOBRjEYQun3eFIzSrupRFmjJArY2jXToMURoylciY"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
                ...
                const transformedConversations = data.map({
                    "AuthProvider.useCallback[fetchAndSetConversations].transformedConversations": (convo)=>{
                        ...
                        return {
                            ...
                            property: {
                                ...convo.property || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["properties"][0],
            ...
            const setupUserSession = {
                "AuthProvider.useEffect.setupUserSession": async (sessionUser)=>{
                    ...
                    if (sessionUser) {
                        ...
                        conversationsChannel = supabase.channel('public:conversations').on('postgres_changes', {
                            event: '*',
                            schema: 'public',
                            table: 'conversations',
                            filter: `or(buyer_id.eq.${sessionUser.id},seller_id.eq.${sessionUser.id})`
                        }, {
...
_s(AuthProvider, "rezgUSrvFnvRMef9XrbrMsoBGfU=", false, function() {
    return [
...
//# sourceMappingURL=src_c602a1d6._.js.map